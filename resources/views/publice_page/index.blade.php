                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="item  item-control card-height ">
                                        ...
                                        <div class="item-title float-start">
                                            <p class="auth">
                                                {{\Illuminate\Support\Str::limit($cardData->name,15)}} <br>
                                                {{\Illuminate\Support\Str::limit($cardData->position,15)}} <br>
                                            </p>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="item item-control">
                                        ...
                                        <p class="details">{{\Illuminate\Support\Str::limit($projectData->description,65)}}<a class="readmore mt-2" href="{{route('singaleProject',$projectData->id)}}" target="">Read more...</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
